...
namespace DATN64.Controllers
{
    public class PortalController : Controller
    {
        ...
        public IActionResult Selection()
        {
            ...
            ViewBag.CanAccessERP = roles.Any(r => r == "Super Admin" || r == "Quản lý cửa hàng" || r == "Nhân viên bán hàng" || r == "Nhân viên kho" || r == "Kế toán" || r == "Marketing");
            ViewBag.CanAccessPOS = roles.Any(r => r == "Super Admin" || r == "Quản lý cửa hàng" || r == "Nhân viên bán hàng");
